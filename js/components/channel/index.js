					...
					<Content showsVerticalScrollIndicator={false}>
						<View>
							<Image source={require("../../../images/NewsIcons/2.jpg")} style={styles.newsPoster}>
								<View>
									<Text
										style={
											Platform.OS === "android" ? styles.achannelHeader : styles.ioschannelHeader
										}
									>
										SCIENCE CHANNEL
									</Text>
						...
						<View foregroundColor={"white"} style={{ backgroundColor: "#fff" }}>
							...
							>
								<View style={styles.newsContentWrap}>
									<Text numberOfLines={2} style={styles.newsHeader}>
										{" "}A "giant impact" collision is thought to have been responsible for forming
										the Moon.
									</Text>
									<Grid style={styles.newsContent}>
										<Col style={{ flexDirection: "row" }}>
							...
							>
								<View style={styles.newsContentWrap}>
									<Text numberOfLines={2} style={styles.newsHeader}>
										Living forms derived from photosynthesis appeared between 3.2 and 2.4 billion
										years ago.
									</Text>
									<Grid style={styles.newsContent}>
										<Col style={{ flexDirection: "row" }}>
